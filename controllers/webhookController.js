...
exports.handleWebhook = (req, res) => {
  ...
  if (queryResult.intent && queryResult.intent.displayName === 'step1') {
    // สร้างข้อมูลจำลองอสังหาริมทรัพย์
    ...
    if (queryResult.intent && queryResult.intent.displayName === 'step2') {
      // สร้างข้อมูลจำลองอสังหาริมทรัพย์
      ...
      if (queryResult.intent && queryResult.intent.displayName === 'step3') {
        // สร้างข้อมูลจำลองอสังหาริมทรัพย์
        ...
        if (queryResult.intent && queryResult.intent.displayName === 'step4') {
          // สร้างข้อมูลจำลองอสังหาริมทรัพย์
          ...
          if (queryResult.intent && queryResult.intent.displayName === 'step5') {
            // สร้างข้อมูลจำลองอสังหาริมทรัพย์
            const propertyResponse = createStep5();
